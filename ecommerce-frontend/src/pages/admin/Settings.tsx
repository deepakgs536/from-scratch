      ...
      <Card className="w-full max-w-4xl border-none shadow-2xl shadow-indigo-100/50 rounded-[2.5rem] overflow-hidden relative bg-white mt-4">
        ...
        <div className="h-72 w-full relative group">
          ...
          {isEditing && (
            <button 
              type="button"
              className="absolute inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer border-none"
              ...
              <div className="w-32 h-32 sm:w-40 sm:h-40 bg-white rounded-full p-1.5 shadow-sm relative overflow-hidden">
                <div className="w-full h-full relative rounded-full overflow-hidden bg-slate-50 border border-slate-100">
                  ...
                  {isEditing && (
                    <button 
                      type="button"
                      className="absolute inset-0 bg-slate-900/50 backdrop-blur-sm flex flex-col items-center justify-center opacity-0 group-hover/avatar:opacity-100 transition-all duration-300 rounded-full cursor-pointer border-none"
